...
RSpec.describe GildedRose do
  context "Normal Item" do
    it "before sell date" do
      items = [Item.new(name: "foo", sell_in: 5, quality: 10)]

      GildedRose.new.process_items(items)

      expect(items[0]).to have_attributes(sell_in: 4, quality: 9)
    end

    it "with min quality" do
      items = [Item.new(name: "foo", sell_in: 5, quality: 0)]
    ...
    it "on sell date near min quality" do
      items = [Item.new(name: "foo", sell_in: 0, quality: 1)]
    ...
    it "after sell date" do
      items = [Item.new(name: "foo", sell_in: -10, quality: 10)]
  ...
  context "Backstage Pass" do
    it "long before sell date" do
      items = [Item.new(name: "Backstage passes to a TAFKAL80ETC concert", sell_in: 11, quality: 10)]
    ...
    it "long before sell date at max quality" do
      items = [Item.new(name: "Backstage passes to a TAFKAL80ETC concert", sell_in: 11, quality: 50)]
    ...
    it "medium close to sell date lower bound" do
      items = [Item.new(name: "Backstage passes to a TAFKAL80ETC concert", sell_in: 6, quality: 10)]
    ...
    it "medium close to sell date lower bound near max quality" do
      items = [Item.new(name: "Backstage passes to a TAFKAL80ETC concert", sell_in: 6, quality: 49)]
    ...
    it "very close to sell date lower bound" do
      items = [Item.new(name: "Backstage passes to a TAFKAL80ETC concert", sell_in: 1, quality: 10)]
    ...
    it "very close to sell date lower bound at max quality" do
      items = [Item.new(name: "Backstage passes to a TAFKAL80ETC concert", sell_in: 1, quality: 50)]
    ...
    it "very close to sell date lower bound near max quality" do
      items = [Item.new(name: "Backstage passes to a TAFKAL80ETC concert", sell_in: 1, quality: 48)]
